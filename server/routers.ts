  ...
  admin: router({
    ...
    properties: router({
      ...
      create: adminProcedure.input(z.object({
        ...
        sizeSqm: z.string().optional(), priceNightly: z.string().optional(), pricePeak: z.string().optional(), priceHigh: z.string().optional(), priceLow: z.string().optional(),
      ...
      update: adminProcedure.input(z.object({
        ...
        priceNightly: z.string().optional(), pricePeak: z.string().optional(), priceHigh: z.string().optional(), priceLow: z.string().optional(),
